...
!     $  jm_global=452         ,
!     $  kb=41                 ,
!     $  im_local=42, !90          ,   !num_of_nodes = 16  4x4
!     $  jm_local=47, !52          ,   !num_of_nodes = 16  4x4
!     $  im_global_coarse=442 ,
...
!    $  period         ,! inertial period
       ...
       parameter(lono=999.0,lato=999.0,xs=1.5,ys=1.5,fak=0.5)!lyo:pac10:
!      parameter(lono=100.6,lato= -5.9,xs=1.5,ys=1.5,fak=0.5)!lyo:pac10:
!     parameter(lono=141.2,lato= 41.8,xs=1.5,ys=1.5,fak=1.0)!lyo:pac10:
!     (i,j)=(427, 575)
!     parameter(lono=114.0,lato= 11.0,xs=1.5,ys=1.5,fak=1.0)!lyo:wpac:
!     (i,j)=(152,225)
...
!lyo:pac10:beg:
      integer
     $  nfe            ,! relax pnts next to bound e !lyo:20110224:alu:stcc:
